...
public interface ExtendedStaticJavaVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code ArithUnaryExp}
	 * labeled alternative in {@link ExtendedStaticJavaParser#exp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArithUnaryExp(ExtendedStaticJavaParser.ArithUnaryExpContext ctx);
	/**
	 * Visit a parse tree produced by the {@code CompUnaryExp}
	 * labeled alternative in {@link ExtendedStaticJavaParser#exp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCompUnaryExp(ExtendedStaticJavaParser.CompUnaryExpContext ctx);
	/**
