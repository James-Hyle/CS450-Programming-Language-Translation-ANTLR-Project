...
public class Optimizer3 extends ClassVisitor {
    ...
    public MethodVisitor visitMethod(int access, String name, String desc,
        ...
        if (mv != null) {
            mv = new RemoveMulDivZero(mv);
        }
        return mv;
    }

    private class RemoveMulDivZero extends MethodVisitor {
        protected boolean SEEN_ZERO = false;
        protected boolean SEEN_OP = false;
        protected int index = -1;

        public RemoveMulDivZero(MethodVisitor mv) {
            super(ASM9, mv);
        }
        ...
        public void visitInsn(int opcode) {
            if ((opcode == IMUL || opcode == IDIV) && SEEN_ZERO && SEEN_OP) {
