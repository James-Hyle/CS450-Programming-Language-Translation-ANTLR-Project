...
public class ExpParser extends Parser {
	...
	public static class ParentExpContext extends ExpContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ExpListener ) ((ExpListener)listener).enterParentExp(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ExpListener ) ((ExpListener)listener).exitParentExp(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ExpVisitor ) return ((ExpVisitor<? extends T>)visitor).visitParentExp(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						((BinaryExpContext)_localctx).lhs = _prevctx;
						...
						setState(17);
						((BinaryExpContext)_localctx).rhs = exp(3);
						}
						break;
					case 2:
						{
						...
						setState(20);
						((BinaryExpContext)_localctx).rhs = exp(2);
						}
						break;
					}
					} 
