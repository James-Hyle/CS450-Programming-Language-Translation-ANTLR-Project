...
public class TypeTable {
   ...
   * </ul>
   */
  public final Map<ASTNode, Type> typeMap;
   ...
   */
  public final Map<Object, Pair<Type, List<Type>>> methodTypeMap;
  ...
  protected TypeTable( final Map<ASTNode, Type> typeMap,
    ...
    assert SymbolTable.checkNonNullElements(typeMap)
        && SymbolTable.checkNonNullElements(methodTypeMap);
  ...
  public String toString() {
    ...
    for (final ASTNode n : this.typeMap.keySet()) {
      set.add("\"" + SymbolTable.getFirstLine(n) + "\" in \""
          + SymbolTable.getFirstLine(n.getParent()) + "\": "
          + SymbolTable.getFirstLine(this.typeMap.get(n)));
    }
